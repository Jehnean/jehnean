...
// Edit background color of mobile nav on scroll - http://stackoverflow.com/questions/8755887/jquery-change-background-color-user-scroll
  $(document).ready(function(){       
            var scroll_pos = 0;
            $(document).scroll(function() { 
                scroll_pos = $(this).scrollTop();
                if(scroll_pos > 210) {
                    $("#main-header").css('background-color', 'rgba(34, 34, 34, 0.97)');
                } else {
  ...
  // $(".projects .isotope-item a").on("click", function (e) {
  //  e.preventDefault();
